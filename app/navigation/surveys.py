...
PARTICIPANT_SURVEY_LEVELS = {20, 30, 40, 50, 60, 70, 80, 100}
...
ALL_SURVEY_LEVELS = PARTICIPANT_SURVEY_LEVELS | MANAGE_SURVEY_LEVELS


def get_navigation(permission_level: int) -> str:
    if permission_level not in ALL_SURVEY_LEVELS:
        return ""

    items = []

    # --- Participate ---
    if permission_level in PARTICIPANT_SURVEY_LEVELS:
